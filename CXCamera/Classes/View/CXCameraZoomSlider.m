...
- (void)setup
{
    ...
    [plusButton setImage:[UIImage imageNamed:CXCameraSrcName(@"icon_camera_plus")] forState:UIControlStateNormal];
    [self addSubview:plusButton];
    self.plusButton = plusButton;
    
    UIButton *substractButton = [[UIButton alloc] init];
    [substractButton setImage:[UIImage imageNamed:CXCameraSrcName(@"icon_camera_subtract")] forState:UIControlStateNormal];
    ...
    [slider setThumbImage:[UIImage imageNamed:CXCameraSrcName(@"slider_handle")] forState:UIControlStateNormal];
